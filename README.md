...
- Custom task-dot thresholds in settings.

---

- 读取 Obsidian 每日笔记任务。
- 支持额外任务来源，也支持年份、月份等多级子文件夹。
- 新建 Daily Note 会自动放入对应年份/月文件夹，支持 `2026` 和 `2026年`。
